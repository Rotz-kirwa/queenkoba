      ...
      >
        <div className="luxury-card">
          ...
          <button
            ...
            className="w-full py-3 bg-white text-gray-700 border border-gray-300 font-body font-semibold text-sm rounded-sm hover:bg-gray-50 transition-colors flex items-center justify-center gap-3"
          >
